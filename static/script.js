  ...
  .addEventListener("submit", async function (event) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        document.getElementById("video-link").textContent =
        ...
        sentimentText.classList.remove(
          "positive",
          "negative",
          "neutral",
          "excitement",
        ...
        if (data.sentiment) {
          ...
          if (sentimentLower.includes("excitement"))
            sentimentText.classList.add("excitement");
          if (sentimentLower.includes("frustration"))
            sentimentText.classList.add("frustration");
          if (sentimentLower.includes("curiosity"))
            sentimentText.classList.add("curiosity");
        }
